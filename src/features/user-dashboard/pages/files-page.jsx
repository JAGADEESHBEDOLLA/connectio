...
export function FilesPage() {
  ...
  return (
    <UserLayout>
      <div className="fixed top-20 bottom-0 left-0 lg:left-[72px] right-0 bg-[#f8fafc] z-[20] flex flex-col overflow-hidden">
        <div className="flex-1 overflow-y-auto px-6 py-8 sm:px-8 sm:py-10 lg:px-12 [scrollbar-width:thin]">
          <div className="mx-auto w-full flex flex-col gap-8 max-w-[1920px]">
            {/* Top Bar */}
                ...
                {mockCategories.map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold whitespace-nowrap transition-all ${isActive
              ...
              <div className="flex items-center gap-3">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full sm:w-64 bg-white border border-brand-line rounded-xl py-2.5 pl-9 pr-4 text-sm focus:ring-2 focus:ring-brand-primary/20 transition-all placeholder:text-brand-secondary shadow-sm"
                  />
                </div>
